...
if(!isset($_SESSION['username'])){
  ...
  $uname=$_SESSION['username'];
	...
	$sql_list="SELECT * FROM purchase_list where purchase_id=$var_purchase_id ORDER BY purchase_id";
...
<head>
    ...
    <title>Manage Purchase | Point of Sale</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Manage Products</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <form action="" name="searchPurForm" onsubmit="" method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Purchase Id</label>
                                                                <input type="text" class="form-control" name="purchase_id" placeholder="Entere Purchase Id "/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="loadList" onclick="return(checkEmpty())">Load</button>
												...
												<div class="form-group-inner">
                                                        <div class="login-btn-inner">
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                     <form action="generate-report-purchase.php" method="POST"><input type="submit" class="btn btn-sm btn-warning" name="generate_report" value="Generate Report"></form>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
										   ...
										   if(!isset($_REQUEST['loadList'])){
											...
											<form action="payDue.php" method="POST"><input type="hidden" name="id" value="<?php echo $row_table['id'];?>"><input type="submit" class="btn btn-sm btn-warning" name="pay_due" value="Pay Dues"></form>
											<?php } ?>
											</td>		
										   <td><form action="" method="POST"><input type="hidden" name="id" value="<?php echo $row_table['id'];?>"><input type="submit" class="btn btn-sm btn-danger" name="returnTosup" value="Return Back"></form></td>
										   </tr>
										   <?php } }?>
										   
										    <?php
										   if(isset($_REQUEST['loadList'])){
											while($row_list=$result_list->fetch(PDO::FETCH_ASSOC)){ $count_sr++?>
										
											<tr>
											
											<td><?php echo $count_sr;?></td>
											<td><?php echo $row_list['purchase_id']?></td>
											<td><?php echo $row_list['total_amount']?></td>
											<td><?php echo $row_list['paid_amount']?></td>
											<td><?php echo $row_list['due_amount']?></td>
											<td><?php echo $row_list['purchased_by']?></td>
											<td><?php echo $row_list['purchasing_time']?></td>
											<td>
											<?php 
											if($row_list['due_amount']==0){
											echo "Paid";
											}else{?>
											<form action="payDue.php" method="POST"><input type="hidden" name="id" value="<?php echo $row_list['id'];?>"><input type="submit" class="btn btn-sm btn-warning" name="pay_due" value="Pay Dues"></form>
											<?php } ?>
											</td>		
										   <td><form action="" method="POST"><input type="hidden" name="id" value="<?php echo $row_list['id'];?>"><input type="submit" class="btn btn-sm btn-danger" name="returnTosup" value="Return Back"></form></td>
										   </tr>
										   <?php } }?>
                                        </tbody>
                                    </table>
