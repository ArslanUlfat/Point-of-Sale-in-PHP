...
if(isset($_REQUEST['delete_cat'])){
	...
	if(!$result){ ?>
			<script>
			alert(" :( Some Thing Went Wrong While Deleting Please Try Again");
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="varifyAddcat.php" name="addCatForm" onsubmit="return(checkConfirm())" method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-4 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Category Name</label>
...
<br>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="Add_cat" onclick="return(checkEmpty())">Add Now</button>
												...
												<div class="form-group-inner">
                                                        <div class="login-btn-inner">
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                     <form action="generate-report-categories.php" method="POST"><input type="submit" class="btn btn-sm btn-warning" name="generate_report" value="Generate Report"></form>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="">
                                <div class="main-sparkline12-hd">
                                    <h1>Catagories <span class="table-project-n">Detail</span> </h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
												...
												<th data-field="category_creat" >Created By</th>
												<th data-field="category_date" >Creation Time</th>
                                        ...
                                        <tbody>
                                           <?php
										    $sql_table="SELECT * FROM productcategory ORDER BY creatdate";
											...
											<td><?php echo $row_table['category']?></td>
											<td><?php if($row_table['status']==1){echo "Active";}else if($row_table['status']==2){echo "DeActive";}?></td>
											<td><?php echo $row_table['createdby']?></td>
											<td><?php echo $row_table['creatdate']?></td>
											<td><form action="update_category.php" method="POST"><input type="hidden" name="id" value="<?php echo $row_table['id'];?>"><input type="submit" class="btn btn-sm btn-warning" name="edit" value="Edit"></form></td>		
										   <td><form action="" method="POST"><input type="hidden" name="id" value="<?php echo $row_table['id'];?>"><input type="submit" class="btn btn-sm btn-danger" name="delete_cat" value="Delete"></form></td>
										   </tr>
											<?php }?>
                                        </tbody>
                                    </table>
	...
	<script>
	 function checkEmpty(){
            category=document.forms["addCatForm"]["category_name"].value
            if(category==""){
                alert("Please Type Category ");
                return false;
            }
			
            status_cat=document.forms["addCatForm"]["category_status"].value
