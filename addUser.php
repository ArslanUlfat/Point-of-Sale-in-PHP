            ...
            <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="varify_addition_user.php" id="loginForm" method="POST" name="add_user_form" onsubmit="return(checkConfirm())">
                            <div class="row">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success loginbtn" name="add_user" onclick="return(checkEmpty())">Add User</button>
