...
if(!isset($_SESSION['username'])){
  ...
  $uname=$_SESSION['username'];
	...
	$sql_list="SELECT * FROM sold_list where sale_id=$var_sale_id ORDER BY sale_id";
...
<head>
    ...
    <title>All Products | Point of Sale</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <form action="generate-report-sales.php" name="searchPurForm" onsubmit="" method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Sale Id</label>
                                                                <input type="text" class="form-control" name="sale_id" placeholder="Entere Sale Id "/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
																		...
																		<button class="btn  btn-sm btn-warning" type="submit" name="generate_report">Generate Report</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="sale_id" data-editable="true">Sale Id</th>
												<th data-field="total" data-editable="true">Total Amount</th>
												<th data-field="paid" data-editable="true">Paid Amount</th>
												<th data-field="due" data-editable="true">Balance</th>
                                              <th data-field="returned" data-editable="true">Returned Amount</th>
											  <th data-field="sub_total_amount" data-editable="true">Sub Total Amount</th>
												<th data-field="Sold_by" >Sold By</th>
												<th data-field="SellTime" >Sell Time</th>
                                        ...
                                        <tbody>
										   ...
										   if(!isset($_REQUEST['loadList'])){
											...
											<td><?php echo $row_table['sale_id']?></td>
											<td><?php echo $row_table['total_amount']?></td>
											<td><?php echo $row_table['pay']?></td>
											<td><?php echo $row_table['balance']?></td>
											<td><?php echo $row_table['returned_amount']?></td>
											<td><?php echo $row_table['sub_total']?></td>
											<td><?php echo $row_table['sold_by']?></td>
											<td><?php echo $row_table['sold_time']?></td>
										   ...
										   if(isset($_REQUEST['loadList'])){
											...
											<td><?php echo $count_sr;?></td>
											<td><?php echo $row_list['sale_id']?></td>
											<td><?php echo $row_list['total_amount']?></td>
											<td><?php echo $row_list['pay']?></td>
											<td><?php echo $row_list['balance']?></td>
											<td><?php echo $row_list['returned_amount']?></td>
											<td><?php echo $row_list['sub_total']?></td>
											<td><?php echo $row_list['sold_by']?></td>
											<td><?php echo $row_list['sold_time']?></td>
