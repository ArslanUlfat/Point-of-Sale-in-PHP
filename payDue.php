...
if(!isset($_SESSION['username'])){
 ...
 if(isset($_REQUEST['pay_due'])){
        $sql_pay="SELECT * FROM purchase_list WHERE id=:id";
        $result_pay=$conn->prepare($sql_pay);
        $id=$_REQUEST['id'];
        $result_pay->execute(array('id'=>$id));
        $row_pay=$result_pay->fetch(PDO::FETCH_ASSOC);
    }
...
<head>
    ...
    <title>Pay Dues | Point of Sale</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Pay Dues</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <form action="pay_due_print.php" name="payDuesForm" onsubmit="return(checkConfirm())" method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Purchase Id</label>
                                                                <input type="text" class="form-control" name="" value="<?php if(isset($row_pay['purchase_id'])){echo $row_pay['purchase_id'];}?>" disabled />
                                                            <input type="hidden" name="purchaseId" value="<?php if(isset($row_pay['purchase_id'])){echo $row_pay['purchase_id'];}?>">
															</div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Dues</label>
                                                                <input type="text" class="form-control" name="dues_box"  value="<?php if(isset($row_pay['due_amount'])){echo $row_pay['due_amount'];}?>" oninput="dues_box(this)" disabled />
																<input type="hidden" name="dues_hidden" value="<?php if(isset($row_pay['due_amount'])){echo $row_pay['due_amount'];}?>">
															</div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Pay</label>
                                                                <input type="text" class="form-control" name="pay" placeholder="Enter Amount To Pay" oninput="_payAmount(this)"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															 <label class="login2 pull-left pull-left-pro">Method</label>
                                                                <select class="form-control" name="supp_status">
...
<br>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
																	 <input type="hidden" name="id" value="<?php echo $row_pay['id']?>">
																	 <input type="hidden" name="paid_Amount_" value="<?php echo $row_pay['paid_amount']?>">
                                                                        <button class="btn btn-sm btn-primary" type="reset">Reset</button>
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="PayNow" onclick="return(checkEmpty())">Pay Now</button>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">Purchase Id</th>
												<th data-field="total" data-editable="true">Total Amount</th>
												<th data-field="paid" data-editable="true">Paid Amount</th>
												<th data-field="due" data-editable="true">Due Amount</th>
                                              
												<th data-field="purchased_by" >Purchased By</th>
												<th data-field="purchasingTime" >Purchasing Time</th>
                                        ...
                                        <tbody>
                                           <?php
											...
											<td><?php echo $row_table['purchase_id']?></td>
											<td><?php echo $row_table['total_amount']?></td>
											<td><?php echo $row_table['paid_amount']?></td>
											<td><?php echo $row_table['due_amount']?></td>
											<td><?php echo $row_table['purchased_by']?></td>
											<td><?php echo $row_table['purchasing_time']?></td>
											<td>
											<?php 
											if($row_table['due_amount']==0){
											echo "Paid";
											}else{?>
											<form action="payDue.php" method="POST"><input type="hidden" name="id" value="<?php echo $row_table['id'];?>"><input type="submit" class="btn btn-sm btn-warning" name="edit" value="Pay Dues"></form>
											<?php } ?>
											</td>		
										   <td><form action="returnBackTosup.php" method="POST"><input type="hidden" name="id" value="<?php echo $row_table['id'];?>"><input type="submit" class="btn btn-sm btn-danger" name="returnTosup" value="Return Back"></form></td>
										   </tr>
											<?php }?>
                                        </tbody>
                                    </table>
	...
	<script>
	 function checkEmpty(){
            sup_name=document.forms["addSupForm"]["suppler_name"].value
            if(sup_name==""){
                alert("Please Type Supplier Name");
                return false;
            }
			sup_cont=document.forms["addSupForm"]["contact_sup"].value
            if(sup_cont==""){
                alert("Please Type Supplier Contact");
                return false;
            }
            status_sup=document.forms["addSupForm"]["supp_status"].value
			
            if(status_sup==" "){
                alert("Please Select Supplier Status");
                return false;
            }
		...
		var due=parseInt(document.forms["payDuesForm"]["dues_box"].value);
		function _payAmount(element){
			var payAmount=element.value;
			document.forms["payDuesForm"]["dues_hidden"].value=due-payAmount;
			document.forms["payDuesForm"]["dues_box"].value=due-payAmount;
