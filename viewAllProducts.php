...
if(!isset($_SESSION['username'])){
  ...
  $uname=$_SESSION['username'];
	...
	$var_product_id=$_REQUEST['product_id'];	
	$sql_list="SELECT * FROM productlist where product_id=$var_product_id ORDER BY product_id";
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Product Id</label>
                                                                <input type="text" class="form-control" name="product_id" placeholder="Entere Sale Id "/>
                                                            </div>
                                                        </div>
                                                    </div>
														<br>
												...
												<div class="form-group-inner">
                                                        <div class="login-btn-inner">
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                     <form action="generate-report-products.php" method="POST"><input type="submit" class="btn btn-sm btn-warning" name="generate_report" value="Generate Report"></form>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="purchase_id" data-editable="true">Product Id</th>
												<th data-field="barcode" data-editable="true">barcode</th>
												<th data-field="name" data-editable="true">Name	</th>
												<th data-field="category" data-editable="true">Category</th>
												<th data-field="supplier" data-editable="">Supplier</th> 
                                                <th data-field="qty" data-editable="true">Qty</th>
												<th data-field="cost" data-editable="true">Cost</th>
												<th data-field="sale" data-editable="true">Sale</th>
												<th data-field="profit" data-editable="true">Profit</th>
												<th data-field="status" data-editable="">Status</th> 
                                                <th data-field="purchased_by" data-editable="true">Purchased By</th>
                                        ...
                                        <tbody>
										   ...
										   if(isset($_REQUEST['loadList'])){
											...
											<td><?php echo $count_sr;?></td>
											<td><?php echo $row_list['product_id']?></td>
											<td><?php echo $row_list['barcode']?></td>
											<td><?php echo $row_list['p_name']?></td>
											<td><?php echo $row_list['p_category']?></td>
											<td><?php echo $row_list['p_supplier']?></td>
											<td><?php echo $row_list['quantity']?></td>
											<td><?php echo $row_list['cost']?></td>
											<td><?php echo $row_list['sale']?></td>
											<td><?php echo $row_list['profit_rupees']?></td>
