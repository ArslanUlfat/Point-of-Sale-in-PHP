...
if(!isset($_SESSION['username'])){
  ...
  $uname=$_SESSION['username'];
      ...
      if(isset($_REQUEST['edit'])){
        $sql_edit="SELECT * FROM productcategory WHERE id=:id";
 ...
 if(isset($_REQUEST['Update_cat'])){
    if(($_REQUEST['category_name']=="")||($_REQUEST['category_status']=="")){

    }else{
        $sql_update="UPDATE productcategory SET id=:id, category=:category, status=:status WHERE id=:id";
        $result_update=$conn->prepare($sql_update);
        $id=$_REQUEST['id'];
        $category=$_REQUEST['category_name'];
        $status=$_REQUEST['category_status'];
        		
        $result_update->execute(array('id'=>$id,'category'=>$category, 'status'=>$status));
    if($result_update){
	?>
			<script>
...
if(isset($_REQUEST['cancel'])){
	header('location:http://localhost/BIT/categories.php');
 }
?>
...
<head>
    ...
    <title>Edit Categories | Point of Sale</title>
...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Category</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Category</label>
                                                                <input type="text" class="form-control" name="category_name" value="<?php if(isset($row_edit['category'])){echo $row_edit['category'];}?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
																		 ...
																		 <form action="" method="POST"><input type="submit" class="btn btn-sm btn-danger" name="cancel" value="Cancel"></form>
																		<button class="btn btn-sm btn-primary" type="reset">Reset</button>
																		<button class="btn btn-sm  btn-warning" type="submit" name="Update_cat" onclick="return(checkEmpty())">Update</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="">
                            <div class="">
                                <div class="main-sparkline13-hd">
                                    <h1>Categories <span class="table-project-n">Detail</span> </h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                           <?php
										    $sql_table="SELECT * FROM productcategory";
											...
											<td><input type="submit" class="btn btn-sm btn-warning" name="" value="Edit"></td>		
										   <td><input type="submit" class="btn btn-sm btn-danger" name="delete_cat" value="Delete"></td>
										   </tr>
											<?php }?>
                                        </tbody>
                                    </table>
	...
	<script>
	 function checkEmpty(){
            category=document.forms["updateCategory"]["category_name"].value
            if(category==""){
                alert("Please Type Category ");
                return false;
            }
			
            status_cat=document.forms["updateCategory"]["category_status"].value
