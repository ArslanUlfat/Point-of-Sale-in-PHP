...
<head>
    ...
    <title>Return Products | Point of Sale</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="verifyReturn.php" name="SaleForm" id="form" onsubmit="return(checkConfirm())" method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-2 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Return No.</label>
                                                                <input type="text" class="form-control" name="" value="<?php echo $return_no;?>" disabled />
																 <input type="hidden" name="return_no" value="<?php echo $return_no;?>">
													...
													<div class="form-group-inner">
                                                        <div class="">
                                                            ...
                                                            <div class="col-lg-3 col-md-2 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Product code;</label>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="add_to_cart" onclick="return(checkEmptyBar())">Add To Cart</button>
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="" data-show-columns="" data-show-pagination-switch="" data-show-refresh="" data-key-events="true" data-show-toggle="" data-resizable="" data-cookie=""
                                        ...
                                        <tbody>
											...
											$sql_table="SELECT * FROM returned_back where return_no=$return_no";
											...
											$count_sr++;
											$totalAmount=$totalAmount+$row_table['price'];
											?>
                            ...
                            <div class="sparkline12-graph">
                                <div class="basic-login-form-ad">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="returnList.php" name="iForm" onsubmit="return(checkConfirm())" method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-2 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Return No.</label>
                                                                <input type="text" class="form-control" name="" value="<?php if(isset($return_no)){echo $return_no;}?>" disabled />
                                                           <input type="hidden" name="return_id" value="<?php if(isset($return_no)){echo $return_no;}?>">
														   </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
													 ...
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Total Amount</label>
                                                                ...
                                                                <input type="text" class="form-control" name="total_amount_disable"  value="<?php if(isset($totalAmount)){echo $totalAmount;}?>" disabled />
																<input type="hidden" name="total_amount" value="<?php if(isset($totalAmount)){echo $totalAmount;}?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                       <input type="hidden" name="barcode_send">
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="return_back" onclick="return(checkInvoice())">Return Back</button>
