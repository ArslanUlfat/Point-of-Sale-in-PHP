...
<head>
    ...
    <title>Manage Users | Point of Sale</title>
                        ...
                        <div class="">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Users <span class="table-project-n">Detail</span></h1>
                                </div>
                            </div>
							<form action="generate-report-users.php" name="searchPurForm" onsubmit="" method="POST">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="firstnmame" data-editable="true">First Name</th>
                                                <th data-field="lastname" data-editable="true">Last Name</th>
                                                <th data-field="email" data-editable="true">Email ID</th>
                                                <th data-field="cell" data-editable="true">Contact No</th>
