...
if(isset($_REQUEST['delete_supplier'])){
	...
	if(!$result){ ?>
			<script>
			alert("Something Went Wrong While Deleting Supplier Please Try Again");
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="varifyAddSup.php" name="addSupForm" onsubmit="return(checkConfirm())" method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Supplier Name</label>
                                                                <input type="text" class="form-control" name="suppler_name" placeholder="Supplier Name"/>
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Contact</label>
                                                                <input type="text" class="form-control" name="contact_sup" placeholder="Contact"/>
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Email</label>
                                                                <input type="text" class="form-control" name="email_sup" placeholder="Email"/>
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Address</label>
                                                                <input type="text" class="form-control" name="address_sup" placeholder="Address"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="Add_sup" onclick="return(checkEmpty())">Add Now</button>
												...
												<div class="form-group-inner">
                                                        <div class="login-btn-inner">
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                     <form action="generate-report-supplier.php" method="POST"><input type="submit" class="btn btn-sm btn-warning" name="generate_report" value="Generate Report"></form>
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
										   ...
										   <td><form action="" method="POST"><input type="hidden" name="id" value="<?php echo $row_table['id'];?>"><input type="submit" class="btn btn-sm btn-danger" name="delete_supplier" value="Delete"></form></td>
										   </tr>
											<?php }?>
                                        </tbody>
                                    </table>
