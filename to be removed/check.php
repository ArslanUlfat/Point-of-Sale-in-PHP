                            ...
                            <div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h1>Products</h1>
													 ...
													 <form action="varify_addition_product.php" id="loginForm" method="POST" name="add_product_form" onsubmit="return(checkConfirm())">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Type Product ID" name="productid">
													 ...
													 <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Bar Code</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">

                                                                    <input type="text" class="form-control" placeholder="" name="barcode">
													 ...
													 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Type Product Name" name="productname">
													...
													<div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Type Product Description" name="productdescription">
                                                            ...
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="input-group">
																  ...
																  <select class="form-control" id="sel1">
																	<?php while($row_supplier=$result_supplier->fetch(PDO::FETCH_ASSOC)){?>
                                                                   ...
                                                                   <!-- <input type="text" class="form-control" placeholder="select category">-->
                                                                    <div class="input-group-btn custom-dropdowns-button">
                                                                        <button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button" aria-expanded="false">Supplier setting<span class="caret"></span>
																			</button>
                                                                        <ul class="dropdown-menu pull-right">
                                                                            <li><a href="#">Add New Supplier</a>
                                                                            </li>
                                                                            <li><a href="#">Manage Supplier</a>
                                                                            </li>
												   ...
												   <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="input-group">
																  ...
																  <select class="form-control" id="sel1">
																	<?php while($row_product=$result_product->fetch(PDO::FETCH_ASSOC)){?>
																	<option><?php echo $row_product['category'];?></option>
																	<?php }?>
																  </select>
																
                                                                   <!-- <input type="text" class="form-control" placeholder="select category">-->
                                                                    <div class="input-group-btn custom-dropdowns-button">
                                                                        <button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button" aria-expanded="false">category setting<span class="caret"></span>
																			</button>
                                                                        <ul class="dropdown-menu pull-right">
                                                                            <li><a href="#">Create New Category</a>
                                                                            </li>
													...
													<div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="number" class="form-control" placeholder="Purchase Price" name="purchaseprice">
													...
													<div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Sale Price</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">

                                                                    <input type="number" class="form-control" placeholder="Set Sale Price" name="saleprice">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" onclick="return(checkEmpty())">Save Change</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
