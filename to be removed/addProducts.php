...
<body>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="varifyAddProducts.php" name="addProductsForm" onsubmit="return(checkConfirm())" method="POST">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Barcode</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="form-group-inner">
                                                     ...
                                                     <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Select supplier</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <div class="input-group">
													 ...
													 <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Expiry Date</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="quantity" oninput="inputFunctionQty(this)"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                     <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Purchase Price Per Item</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="purchasepriceperitem" oninput="inputFunctionPurchasePrice(this)" />
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Total Purchase Price</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="totalpurchaseprice" oninput="inputFunctionTotalPrice(this)"/>
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Sale Price per Item</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="salepriceperitem" oninput="inputFunctionSalePricePerItem(this)" />
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Total Sale Price</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="totalsaleprice" oninput="inputFunctionTotalSalePrice(this)"/>
                                                            </div>
                                                        </div>
                                                    </div>
														<div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Profit</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="profitMargin"  />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="save" onclick="return(checkEmpty())">Save Change</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
	...
	<script>
	 function checkEmpty(){
            productId=document.forms["addProductsForm"]["productid"].value
            if(productId==""){
                alert("Enter Product Id");
                return false;
            }
            barcode=document.forms["addProductsForm"]["barcode"].value
            if(barcode==""){
                alert("Enter Product Barcode");
                return false;
            }
            productname=document.forms["addProductsForm"]["productname"].value
            if(productname==""){
                alert("Enter Product Name");
                return false;
            }
            quantity=document.forms["addProductsForm"]["quantity"].value
            if(quantity==""){
                alert("Enter Product Quantity");
                return false;
            }
            pprice=document.forms["addProductsForm"]["purchasepriceperitem"].value
            if(pprice==""){
                alert("Enter Product Purchase Price");
                return false;
            }
            sprice=document.forms["addProductsForm"]["salepriceperitem"].value
            if(sprice==""){
		...
		//input funtion purchase price per item
		function inputFunctionPurchasePrice(element){
			var quantity=parseInt(document.forms["addProductsForm"]["quantity"].value);
			var purchasePricePerItem=element.value;
			document.forms["addProductsForm"]["totalpurchaseprice"].value=quantity*purchasePricePerItem;
			
		}
	//input funtion purchase price per item
		function inputFunctionTotalPrice(element){
			var quantity=parseInt(document.forms["addProductsForm"]["quantity"].value);
			var totalprice=element.value;
			document.forms["addProductsForm"]["purchasepriceperitem"].value=totalprice/quantity;
			
		}
			//input funtion purchase price per item
		function inputFunctionQty(element){
			var quantity=element.value;
			var PurchasePrice=document.forms["addProductsForm"]["purchasepriceperitem"].value;
			
			document.forms["addProductsForm"]["totalpurchaseprice"].value=quantity*PurchasePrice;
			setZero();
		}
			//input funtion purchase price per item
		function inputFunctionSalePricePerItem(element){
			var quantity=parseInt(document.forms["addProductsForm"]["quantity"].value);
			var salePricePerItem=element.value;
			var total_salePrice=quantity*salePricePerItem;
			document.forms["addProductsForm"]["totalsaleprice"].value=total_salePrice;
			profitFun(total_salePrice);
		}
		//input funtion purchase price per item
		function inputFunctionTotalSalePrice(element){
			var quantity=parseInt(document.forms["addProductsForm"]["quantity"].value);
			var totalSalePrice=element.value;
			
			document.forms["addProductsForm"]["salepriceperitem"].value=totalSalePrice/quantity;
			profitFunWrt(totalSalePrice);
		}
		function profitFun(total_salePrice){
			var total_saleP=total_salePrice;
			var total_p=document.forms["addProductsForm"]["totalpurchaseprice"].value;
			var profitt=total_saleP-total_p;
			document.forms["addProductsForm"]["profitMargin"].value=profitt;
		}
		function profitFunWrt(totalSalePrice){
			var totalSALEprice=totalSalePrice;
			var totalPURCHASEprice=document.forms["addProductsForm"]["totalpurchaseprice"].value;
		    var profit_cal=totalSALEprice-totalPURCHASEprice;
			document.forms["addProductsForm"]["profitMargin"].value=profit_cal;
		 }
		 function setZero(){
			  document.forms["addProductsForm"]["salepriceperitem"].value=0;
			 document.forms["addProductsForm"]["totalsaleprice"].value=0;		
			document.forms["addProductsForm"]["profitMargin"].value=0;
		 }
        </script>
	</script>
</body>
