...
if(isset($_REQUEST['generate_report'])){
	$sql_table="SELECT * FROM supplier ORDER BY id";
...
<body>
	...
	<td class="text-center"><b>suppliername</b></td>
	...
	<td class="text-center"><b>addedby</b></td>
	...
	$NO++;
	$supplier=$row_table['suppliername'];
	$contact=$row_table['contact'];
	$email=$row_table['email'];
	$address=$row_table['address'];
	$addby=$row_table['addedby'];
	$time=$row_table['add_date'];
	...
	<td class="text-center"><?php echo $addby; ?></td>
