...
if(isset($_REQUEST['generate_report'])){
	$sql_table="SELECT * FROM users ORDER BY id";
...
<body>
	...
	<td class="text-center"><b>Registration Time</b></td>
	...
	$phone=$row_table['cell'];
	$gender=$row_table['gender'];
	
	$time=$row_table['reg_date'];
