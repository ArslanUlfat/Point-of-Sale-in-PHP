...
if(!isset($_SESSION['username'])){
  ...
  $uname=$_SESSION['username'];
      ...
      if(isset($_REQUEST['edit'])){
        $sql_edit="SELECT * FROM supplier WHERE id=:id";
        $result_edit=$conn->prepare($sql_edit);
        $id=$_REQUEST['id'];
        $result_edit->execute(array('id'=>$id));
        $row_edit=$result_edit->fetch(PDO::FETCH_ASSOC);
    }
 if(isset($_REQUEST['Update_supp'])){
    if(($_REQUEST['suppler_name']=="")||($_REQUEST['contact_sup']=="")||($_REQUEST['supp_status']=="")){

    }else{
        $sql_update="UPDATE supplier SET id=:id, suppliername=:suppliername, contact=:contact, email=:email, address=:address, status=:status WHERE id=:id";
        $result_update=$conn->prepare($sql_update);
        $id=$_REQUEST['id'];
        $var_name=$_REQUEST['suppler_name'];
		$var_contact=$_REQUEST['contact_sup'];
		$var_email=$_REQUEST['email_sup'];
		$var_address=$_REQUEST['address_sup'];
        $var_status=$_REQUEST['supp_status'];
        		
        $result_update->execute(array('id'=>$id,'suppliername'=>$var_name,'contact'=>$var_contact,'email'=>$var_email,'address'=>$var_address, 'status'=>$var_status));
		if($result_update){ ?>
			<script>
			alert("Successfully Edited Supllier");
			window.location.href="supplier.php";
			</script>
<?php	}else{ ?>
			<script>
			alert("Something Went Wrong While Editing Supplier Please Try Again");
			window.location.href="supplier.php";
			</script>
<?php	}
	}
...
if(isset($_REQUEST['cancel'])){
	header('location:http://localhost/BIT/supplier.php');
 }
?>
...
<head>
    ...
    <title>Edit Suppliers | Point of Sale</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.php"><img class="main-logo" src="img/logo/logo2.png" width="82" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="" name="addSupForm"  method="POST">
                                                    <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Supplier Name</label>
                                                                <input type="text" class="form-control" name="suppler_name" value="<?php if(isset($row_edit['suppliername'])){echo $row_edit['suppliername'];}?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Contact</label>
                                                                <input type="text" class="form-control" name="contact_sup" value="<?php if(isset($row_edit['contact'])){echo $row_edit['contact'];}?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Email</label>
                                                                <input type="text" class="form-control" name="email_sup" value="<?php if(isset($row_edit['email'])){echo $row_edit['email'];}?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Address</label>
                                                                <input type="text" class="form-control" name="address_sup"value="<?php if(isset($row_edit['address'])){echo $row_edit['address'];}?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
																	 <input type="hidden" name="id" value="<?php echo $row_edit['id']?>">
                                                                       <form action="" method=""><input type="submit" class="btn btn-sm btn-danger" name="cancel" value="Cancel"></form>
																	   <button class="btn btn-sm btn-primary" type="reset">Reset</button>
                                                                      <button class="btn btn-sm  btn-warning" type="submit" name="Update_supp" onclick="return(checkEmpty())">Update</button>
                        ...
                        <div class="">
                            <div class="">
                                <div class="main-sparkline13-hd">
                                    <h1>Suppliers <span class="table-project-n">Detail</span></h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">Supplier Name</th>
												<th data-field="concat" data-editable="true">Contact</th>
												<th data-field="email" data-editable="true">Email</th>
												<th data-field="address" data-editable="true">Address</th>
                                                <th data-field="category_status" >Status</th>
												<th data-field="addedby" >Added By</th>
												<th data-field="add_date" >Adding Time</th>
                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                           <?php
										    $sql_table="SELECT * FROM supplier ORDER BY add_date";
											...
											<td><?php echo $row_table['suppliername']?></td>
											<td><?php echo $row_table['contact']?></td>
											...
											<td><?php echo $row_table['addedby']?></td>
											<td><?php echo $row_table['add_date']?></td>
											</tr>
											<?php }?>
                                        </tbody>
                                    </table>
