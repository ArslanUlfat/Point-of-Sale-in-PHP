...
if(isset($_REQUEST['loadList'])){
	...
	$sql_list="SELECT * FROM productlist where barcode=$var_barcode ORDER BY product_id";
...
<head>
    ...
    <title>Update Stock | Point of Sale</title>
                ...
                <div class="row">
					...
					<div class="sparkline12-hd">
                                <div class="main-sparkline12-hd">
                                    <h5>Following Products are out of Stock. These Need Updation</h5>
                                </div>
                            </div>
					<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="pro_id">Product Id</th>
                                                <th data-field="barcode" >Barcode</th>
												<th data-field="pro_name" >Product Name</th>
                                        ...
                                        <tbody>
                                           <?php
										    $sql_table="SELECT * FROM productlist WHERE quantity<min_stock_level";
					...
					<br>
					 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
							...
							<form  action="" name="load" method="POST" >
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="loadList" >Load</button>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="varify_update_stock.php" name="purchaseProForm" onsubmit="return(checkConfirm())" method="POST">
                                                   <div class="form-group-inner">
                                                        <div class="">
                                                            
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Barcode</label>
                                                                <input type="text" class="form-control" name="" value="<?php if(isset($row_list['barcode'])){ echo $row_list['barcode'];}?>" />
                                                            <input type="hidden" name="barcode"  value="<?php if(isset($row_list['barcode'])){ echo $row_list['barcode'];}?>">
												   ...
												   <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Purchase ID</label>
                                                                <input type="text" class="form-control" name="" value="<?php if(isset($row_list['purchase_id'])){ echo $row_list['purchase_id'];}?>"  disabled  />
                                                            <input type="hidden" name="purchase_id"  value="<?php if(isset($row_list['purchase_id'])){ echo $row_list['purchase_id'];}?>">
															</div>
                                                        </div>
                                                    </div>
												   <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Brand Name</label>
                                                                <input type="text" class="form-control" name="" value="<?php if(isset($row_list['p_name'])) { echo $row_list['p_name'];}?>" disabled/>
																 <input type="hidden" name="brand_name"  value="<?php if(isset($row_list['p_name'])) { echo $row_list['p_name'];}?>">
													...
													<div class="form-group-inner">
                                                        <div class="">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-9 col-xs-12">
															<label class="login2 pull-left pull-left-pro">Available Stock</label>
                                                                <input type="text" class="form-control" name="" value="<?php if(isset($row_list['quantity'])) { echo $row_list['quantity'];}?>" disabled/>
																<input type="hidden" name="stock"  value="<?php if(isset($row_list['quantity'])) { echo $row_list['quantity'];}?>">
													 ...
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Quantity</label>
                                                                <input type="text" class="form-control" name="qty" placeholder="Quantity" oninput="_qty(this)" required />
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Cost Price(Rs.)</label>
                                                                <input type="text" class="form-control" name="cost_price" placeholder="Cost Price" oninput="cost(this)" required />
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Cost Price(Rs.)/Item</label>
                                                                <input type="text" class="form-control" name="cost_price_item" placeholder="Cost Price/Item" oninput="_cost_item(this)" required />
                                                            </div>
                                                        </div>
                                                    </div>
													 ...
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Sale Price(Rs.)</label>
                                                                <input type="text" class="form-control" name="sale_price" placeholder="Set Sale Price" oninput="sale(this)"  required />
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Sale Price/Item(Rs.)</label>
                                                                <input type="text" class="form-control" name="slae_price_item" placeholder="Sale Price/Item" oninput="_sale_item(this)"  required />
                                                            </div>
                                                        </div>
                                                    </div>
													 ...
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Total Amount</label>
                                                                ...
                                                                <input type="text" class="form-control" name="total_amount_script"   disabled />
													 ...
													 <div class="form-group-inner">
                                                        <div class="">
															...
															<label class="login2 pull-left pull-left-pro">Pay</label>
                                                                <input type="text" class="form-control" name="pay" placeholder="Enter Amount to Pay" oninput="Pay_amount(this)" required />
                                                            </div>
                                                        </div>
                                                    </div>
													 <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <button class="btn  btn-sm btn-success" type="submit" name="update_stock" >Update</button>
	...
	<script>
	 function checkEmpty(){
		...
		function cost(element){
			...
			document.forms["purchaseProForm"]["total_amount_script"].value=cost;
			document.forms["purchaseProForm"]["total_amount"].value=cost;
		}
		...
		function setZero(){
			...
			document.forms["purchaseProForm"]["sale_price"].value="";
			document.forms["purchaseProForm"]["slae_price_item"].value="";
		}
		function Pay_amount(element){
			var payAmount=element.value;
			
			var totalAmount=document.forms["purchaseProForm"]["total_amount"].value;
			document.forms["purchaseProForm"]["due_script"].value=totalAmount-payAmount;
			document.forms["purchaseProForm"]["due"].value=totalAmount-payAmount;
		}
